...
#SBATCH --error=/cluster/tufts/hugheslab/swilli26/slurmlog/err/log_%j.err
#SBATCH --gres=gpu:rtx_6000:1
#SBATCH --mem=16g
#SBATCH --ntasks=4
#SBATCH --output=/cluster/tufts/hugheslab/swilli26/slurmlog/out/log_%j.out
...
experiments=(
    'python ../src/encode_cifar10.py --batch_size=128 --cifar10_dir="/cluster/tufts/hugheslab/swilli26/CIFAR10_DATA" --cifar101_v4_dir="/cluster/tufts/hugheslab/swilli26/CIFAR10.1_DATA" --encoded_path="/cluster/tufts/hugheslab/swilli26/RFF_PAPER/random-Fourier-features/datasets/CIFAR-10/n=100_random_state=1001.pth" --n=100 --num_workers=0 --random_state=1001'
